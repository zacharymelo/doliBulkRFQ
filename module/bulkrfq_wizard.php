...
print_liste_field_titre($langs->trans('RfqProductRef'), $_SERVER['PHP_SELF'], 'p.ref', '', $param, '', $sortfield, $sortorder);
print_liste_field_titre($langs->trans('RfqProductLabel'), $_SERVER['PHP_SELF'], 'p.label', '', $param, '', $sortfield, $sortorder);
print_liste_field_titre($langs->trans('RfqProductType'), $_SERVER['PHP_SELF'], 'p.fk_product_type', '', $param, '', $sortfield, $sortorder);
...
print '<th>'.$langs->trans('RfqProductRef').'</th>';
print '<th>'.$langs->trans('RfqProductLabel').'</th>';
print '<th class="right">'.$langs->trans('Qty').'</th>';
